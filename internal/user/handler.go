...
func (h *UserHandler) Register(w http.ResponseWriter, r *http.Request) {
	...
	if err := framework.ParseRequest(r, &req); err != nil {
		framework.Respond(w, r, http.StatusBadRequest, errorBody{"Registration's format incorrect."})
		return
	}
	...
	if err != nil {
		...
		case errors.Is(err, ErrEmailDuplicate):
			framework.Respond(w, r, http.StatusBadRequest, errorBody{"Duplicate email"})
		default:
			framework.Respond(w, r, http.StatusBadRequest, errorBody{"Registration's format incorrect."})
		}
		return
...
func (h *UserHandler) Login(w http.ResponseWriter, r *http.Request) {
	...
	if err := framework.ParseRequest(r, &req); err != nil {
		framework.Respond(w, r, http.StatusBadRequest, errorBody{"Login's format incorrect."})
		return
	}
	...
	if err != nil {
		...
		case errors.Is(err, ErrCredentialsInvalid):
			framework.Respond(w, r, http.StatusBadRequest, errorBody{"Credentials Invalid"})
		default:
			framework.Respond(w, r, http.StatusBadRequest, errorBody{"Login's format incorrect."})
		}
		return
...
func (h *UserHandler) UpdateName(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		framework.Respond(w, r, http.StatusUnauthorized, errorBody{"Can't authenticate who you are."})
		return
	}

	targetID, err := strconv.Atoi(framework.PathParam(r, "userId"))
	if err != nil {
		framework.Respond(w, r, http.StatusBadRequest, errorBody{"Name's format invalid."})
		return
	}
	...
	if err := h.service(r).UpdateName(caller.ID, targetID, req.NewName); err != nil {
		...
		case errors.Is(err, ErrForbidden):
			framework.Respond(w, r, http.StatusForbidden, errorBody{"Forbidden"})
		default:
			framework.Respond(w, r, http.StatusBadRequest, errorBody{"Name's format invalid."})
		}
		return
